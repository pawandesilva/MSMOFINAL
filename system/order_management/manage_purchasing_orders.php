...
<div class="row col-md-10">
    <div class="col-sm-4 mb-3 mb-sm-1">
        <div class="card h-100">
            <div class="card-body d-flex flex-column">
                <h1 class="card-title card-title-large">Create Purchasing Orders</h1>
    ...
    <div class="col-sm-4 mb-3 mb-sm-1">
        <div class="card h-100">
            <div class="card-body d-flex flex-column">
                <h1 class="card-title card-title-large">View purchasing Orders</h1>
                <img class="card-img img-content-fluid mb-3" src="../assets/dist/img/credit/order-inquiry-3.png" alt=""/>
                <div class="text-center mt-auto">
                    <a href="display_po.php">
                        <button type="submit" class="btn border border-1 border-dark btn-info w-100 mt-3 align-center">View Orders</button>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="col-sm-4 mb-3 mb-sm-1">
        <div class="card h-100">
            <div class="card-body d-flex flex-column">
                <h1 class="card-title card-title-large">Approve purchasing Orders</h1>
                <img class="card-img img-content-fluid mb-3" src="../assets/dist/img/approve.jpg" alt=""/>
                <div class="text-center mt-auto">
                    <a href="approve_po.php">
                        <button type="submit" class="btn border border-1 border-dark btn-success w-100 mt-3 align-center">Approve Orders</button>
                    </a>
                </div>
            </div>
        </div>
