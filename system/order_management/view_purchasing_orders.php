    ...
    <div class="col-12"> 
        <div class="container order-container">
            ...
            <div class="invoice p-3 mb-3" id="contentToPrint">
                <!-- title row -->
                <div class="row" style="background-color:#B7D496; color: #ffffff; padding: 10px; border-radius: 8px;height: 150px; display: flex; border: darkgreen">
                    ...
                    <div class="col-4 text-center d-flex align-items-center justify-content-center">
                        <h4 style="margin: 0;">
                            <i class="fas fa-list"></i> <strong><h2 class='font-weight-bold ' style="color: #916A2C;">Purchasing Order</h2></strong>
                        </h4>
                    </div>
                ...
                WHERE po.OrderId = 1;";
                            ...
                            <?php
                            $db = dbConn();
                            $sql = "SELECT po_items.Material, po_items.Qty, po.ProductDescription 
                FROM purchasing_orders po 
