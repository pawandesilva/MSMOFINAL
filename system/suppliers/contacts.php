                    ...
                    <div class="card bg-light d-flex flex-fill">
                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-7">
                                    ...
                                    <div><b>Reg No: <strong class="text-danger"><?= $row['RegNo'] ?></strong></b></div>
                                    <p class="text-muted text-sm"><b>Bio: </b> <?= $row['Bio']?></p>
                        ...
                        <div class="card-footer">
                            <div class="text-right">
                                ...
                                <a href="supplier_profile.php?supplierId=<?=$row['SupplierId']?> " class="btn btn-sm btn-primary">
