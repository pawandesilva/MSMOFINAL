...
Piliyandala, Sri Lanka.</a></small>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="home.php" class="navbar-brand"><h1 class="text-primary display-6">Mal Organics</h1></a>
                    <a href="supplier_dashboard.php" class="text-decoration-none">
                        <h1 class="text-capitalize">Supplier Dashboard</h1>
                    </a>
