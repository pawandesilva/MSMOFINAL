                                ...
                                <div class="card-body">
                                    <div class="container rounded bg-white mt-5 mb-5">
                                        ...
                                        extract($_POST);
                                            ...
                                            $db = dbConn();
                                            echo $sql = "SELECT * FROM suppliers s INNER JOIN users u ON s.UserId=u.UserId WHERE s.SupplierId='$supplierId'";
                                            $result = $db->query($sql);
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 border-right">
                                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                                        <!-- default Image -->
                                                        <img id="profilephoto" class="rounded-circle mt-5" width="150px" src='$pr' alt="Profile Image"> 
                                                        <input type="hidden" value="<?= $profileImage?>" name="prv_profileImage">
                                                        <img src="../uploads/66783b557bba24.95776416.png" alt=""/>
                                                        <!-- Image upload button-->
